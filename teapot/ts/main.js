...
window.onload = function () {
    ...
    for (var i = 0; i < 10; i++) {
        if (i % 2 == 0)
            Shapes.push(new Shape(new Float32Array([i / 5, 0.0, 0.0]), new Float32Array([1.0, 0.0, 1.0]), Octa));
        else
            Shapes.push(new Shape(new Float32Array([i, 0.0, 0.0]), new Float32Array([1.0, 0.0, 1.0]), Teapot));
    }
};
var Timer = 0;
function Update() {
...
var Shape = (function () {
    function Shape(npos, ncol, nmodel) {
        this.Model = nmodel;
        this.Position = npos;
    ...
    Shape.prototype.Render = function () {
        ...
        mat4.fromTranslation(view, new Float32Array([0.0, 0.0, -3.0]));
        ...
        Simple.UniformVec3("ViewPosition", new Float32Array([0.0, 0.0, 3.0]));
